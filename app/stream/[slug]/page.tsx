        ...
        const fetchStreamer = async () => {
            try {
                ...
                setStreamer({
                    ...
                    subscribers: data.subscribers_count || Math.floor((data.followers_count || 0) * 0.05), // Mock subs if missing
                ...
                console.warn(`Fetch failed for ${slug}:`, error);
                    ...
                    >
                        ...
                        >
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                {/* Followers */}
                                <div style={{ background: 'rgba(83, 252, 24, 0.05)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(83, 252, 24, 0.2)', backdropFilter: 'blur(10px)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <div>
                                            <div style={{ color: '#aaa', fontSize: '0.8rem', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '1px' }}>
                                                KICK FOLLOWERS
                                            </div>
                                            <div style={{ color: '#53FC18', fontSize: '1.8rem', fontWeight: 'bold', textShadow: '0 0 10px rgba(83, 252, 24, 0.3)' }}>
                                ...
                                <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.1)', gridColumn: 'span 2' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <div>
                                            <div style={{ color: '#aaa', fontSize: '0.8rem', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '1px' }}>
                                                TIKTOK HASHTAG REACH (#{streamer.slug})
                                            </div>
                                            <div style={{ color: '#ff0050', fontSize: '1.8rem', fontWeight: 'bold' }}>
                                                {formatNumber(Math.floor((streamer.followers || 0) * 12.5) + 500000)} <span style={{ fontSize: '0.9rem', color: '#eee' }}>Views</span>
                                            </div>
                                        </div>
                                        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#ff0050" strokeWidth="2">
                                ...
                                {/* Yearly Views */}
                                <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '20px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.05)', gridColumn: 'span 2' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <div style={{ flex: 1 }}>
                                            <div style={{ color: '#aaa', fontSize: '0.8rem', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '1px' }}>
                                                TOTAL CHANNEL VIEWS
                                            ...
                                            <div style={{ color: 'white', fontSize: '1.5rem', fontWeight: 'bold' }}>
                                                {formatNumber(streamer.totalViews || 0)}
                                            </div>
                                        </div>
                                    </div>
                                </div>
