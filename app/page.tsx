...
export default function Home() {
  ...
  // Carousel Logic - always use online streamers if available, otherwise first 5
  const featuredStreamers = onlineStreamers.length > 0 ? onlineStreamers : streamers.slice(0, 5);
